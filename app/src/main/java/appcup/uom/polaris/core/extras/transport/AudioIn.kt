...
internal class AudioIn @RequiresPermission(Manifest.permission.RECORD_AUDIO) constructor(
    sampleRateHz: Int,
                ...
                while (!stop.get()) {
                    ...
                    try {
                        ...
                        while (!stop.get() && !mute.get()) {
                            ...
                            onAudioLevelUpdate(GeminiClient.Companion.calculateAudioLevel(buf))
