...
fun createQuest(placesList: String, currentLocation: String, preference: String) : String {
    return """
        Generate a quest list for a user currently located in: `$currentLocation`.
